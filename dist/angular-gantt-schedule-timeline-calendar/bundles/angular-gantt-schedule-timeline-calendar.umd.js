(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('gantt-schedule-timeline-calendar/dist/index.esm.js')) :
    typeof define === 'function' && define.amd ? define('angular-gantt-schedule-timeline-calendar', ['exports', '@angular/core', 'gantt-schedule-timeline-calendar/dist/index.esm.js'], factory) :
    (global = global || self, factory(global['angular-gantt-schedule-timeline-calendar'] = {}, global.ng.core, global.GSTC));
}(this, (function (exports, core, GSTC) { 'use strict';

    GSTC = GSTC && Object.prototype.hasOwnProperty.call(GSTC, 'default') ? GSTC['default'] : GSTC;

    var _c0 = ["gstcElement"];
    var GSTCComponent = /** @class */ (function () {
        function GSTCComponent() {
            this.onState = new core.EventEmitter();
        }
        GSTCComponent.prototype.ngAfterViewInit = function () {
            var element = this.gstcElement.nativeElement;
        ...
        GSTCComponent.prototype.ngOnDestroy = function () {
            this.GSTC.app.destroy();
        };
        GSTCComponent.ɵfac = function GSTCComponent_Factory(t) { return new (t || GSTCComponent)(); };
        GSTCComponent.ɵcmp = core.ɵɵdefineComponent({ type: GSTCComponent, selectors: [["gstc"]], viewQuery: function GSTCComponent_Query(rf, ctx) { if (rf & 1) {
                core.ɵɵstaticViewQuery(_c0, true);
            } if (rf & 2) {
                var _t;
                core.ɵɵqueryRefresh(_t = core.ɵɵloadQuery()) && (ctx.gstcElement = _t.first);
        ...
        return GSTCComponent;
    }());
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(GSTCComponent, [{
            type: core.Component,
            args: [{
                    selector: "gstc",
    ...
    var AngularGanttScheduleTimelineCalendarModule = /** @class */ (function () {
        function AngularGanttScheduleTimelineCalendarModule() {
        }
        AngularGanttScheduleTimelineCalendarModule.ɵmod = core.ɵɵdefineNgModule({ type: AngularGanttScheduleTimelineCalendarModule });
        AngularGanttScheduleTimelineCalendarModule.ɵinj = core.ɵɵdefineInjector({ factory: function AngularGanttScheduleTimelineCalendarModule_Factory(t) { return new (t || AngularGanttScheduleTimelineCalendarModule)(); }, imports: [[]] });
        return AngularGanttScheduleTimelineCalendarModule;
    }());
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && core.ɵɵsetNgModuleScope(AngularGanttScheduleTimelineCalendarModule, { declarations: [GSTCComponent], exports: [GSTCComponent] }); })();
    /*@__PURE__*/ (function () { core.ɵsetClassMetadata(AngularGanttScheduleTimelineCalendarModule, [{
            type: core.NgModule,
            args: [{
    ...
    exports.AngularGanttScheduleTimelineCalendarModule = AngularGanttScheduleTimelineCalendarModule;
    exports.GSTCComponent = GSTCComponent;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=angular-gantt-schedule-timeline-calendar.umd.js.map
